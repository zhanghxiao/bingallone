...
const WEB_CONFIG = {
  WORKER_URL: 'https://cfree.nbing.eu.org', // 如无特殊需求请，保持为''
};

const SYDNEY_ORIGIN = 'https://cfree.nbing.eu.org';
const BING_ORIGIN = 'https://cfree.nbing.eu.org';
// const ENDPOINT="https://cfree.nbing.eu.org";
...
const home = async (pathname) => {
  const baseUrl = 'https://raw.githubusercontent.com//zhanghxiao/go-proxy-bingai/master/';
  let url;
